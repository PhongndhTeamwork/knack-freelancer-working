                    ...
                    <div className="space-y-5">
                                ...
                                <div className="w-full mx-auto p-4 shadow border rounded-md">
                                    <div className="space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor="serviceType" className="responsive-text-16">Lĩnh vực
                                                1</Label>
                                            <Input id="serviceType" placeholder="Người mẫu"
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                                            ...
                                            <div className="md:col-span-3 space-y-2">
                                                <Label htmlFor="serviceName" className="responsive-text-16">Dịch
                                                    vụ</Label>
                                            ...
                                            {/* Service Fee */}
                                            <div className="md:col-span-3 space-y-2">
                                                <Label htmlFor="serviceFee" className="responsive-text-16">Phí dịch
                                                    vụ</Label>
                                            ...
                                            <div className="md:col-span-6 space-y-2">
                                                <Label htmlFor="description" className="responsive-text-16">Mô
                                                    tả</Label>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-8 mt-6 p-4 shadow border rounded-md">
                                ...
                                <div className="space-y-2 w-full">
                                    <Label htmlFor="pricingLink1" className="responsive-text-16">Link đến biểu giá của
                                        bạn</Label>
                                    <Input
                                        id="pricingLink1"
                                        placeholder=""
